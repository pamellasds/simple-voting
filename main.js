...
let contractAddress = "0x63B12530eaD2217105Ca99a2c4f937feBb3b6be7";
let contractAbi = [
    {
      "inputs": [
        {
...
const getAllCandidates = async() => {
    ...
    var candidates = await contractInstance.getAllVotesOfCandidate();
...
const voteStatus = async() => {
    if (WALLET_CONNECTED != 0) {
        ...
        var status = document.getElementById('status');
        remainingTime.innerHTML = `Please, connect metamask first.`
    }
}
...
const addVote = async() => {
    if (WALLET_CONNECTED != 0) {
        ...
        cand.innerHTML = "Voting is added.";
    } else {
        var cand = document.getElementById("cand");
